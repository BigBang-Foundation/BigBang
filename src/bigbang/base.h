...
public:
    ...
    virtual bool SignTransaction(const CDestination& destIn, CTransaction& tx, const vector<uint8>& vchDestInData, const vector<uint8>& vchSendToData, const uint256& hashFork, const int32 nForkHeight, bool& fCompleted) = 0;
...
public:
    ...
    virtual bool SignTransaction(CTransaction& tx, const vector<uint8>& vchDestInData, const vector<uint8>& vchSendToData, bool& fCompleted) = 0;
