...
#ifndef COMMON_TEMPLATE_UEESIGN_H
#define COMMON_TEMPLATE_UEESIGN_H

#include "template.h"

class CTemplateUeeSign : virtual public CTemplate, virtual public CSendToRecordedTemplate
{
public:
    CTemplateUeeSign(const CDestination& destOwnerIn = CDestination(), const CDestination& destAdminIn = CDestination());
    virtual CTemplateUeeSign* clone() const;
...
public:
    ...
    CDestination destAdmin;
};

#endif // COMMON_TEMPLATE_UEESIGN_H
